...
Codec selection, quality optimization, hardware acceleration.
...
Encoding speed vs file-size trade-off.
...
### Multi-Threading
FFmpeg auto-uses multiple cores; override if needed:
...
### Tune Options
Optimize encoder for content types:
...
---
Continued in [ffmpeg-encoding-cont.md](ffmpeg-encoding-cont.md).
