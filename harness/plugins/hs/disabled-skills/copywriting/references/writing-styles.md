...
Every writing style maps across these dimensions:
...
Use this prompt to analyze content and extract its style:
...
Prompt to write in a specific style:
...
- `hs:copywriting` skill workflows - Style-aware content generation
