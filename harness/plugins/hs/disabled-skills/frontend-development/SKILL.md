...
Guide for modern React dev: Suspense-based data fetching, lazy loading, file organization, performance optimization.

**Probe-first ★** (`harness/rules/agent-operational-discipline.md` — the priority discipline): how a library / hook / bundler / browser API behaves gets verified by RUNNING it (a spike, the real render) before you build on it — reading the lib docs or a blog post is a *hypothesis*, NOT a probe. An unrun claim is `[ASSUMED]`, never OBSERVED; never report a component
...
**Skill Status**: Modular, progressive-loaded for context efficiency
