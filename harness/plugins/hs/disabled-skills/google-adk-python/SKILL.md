...
Google's Agent Development Kit (ADK) Python — open-source, code-first toolkit to build, evaluate, deploy AI agents. Optimized for Gemini, model-agnostic.
...
Use `App` for plugins, event compaction, or custom lifecycle management.
