...
Loaded for `--discover`. A pre-stage ingesting raw upstream inputs (interview transcripts, support-ticket dumps, competitor notes), proposing **candidate** personas/problems/JTBD to **seed** the Vision/BRD interview vs. a cold start. **Never auto-commits** — the interview confirms field-by-field.
