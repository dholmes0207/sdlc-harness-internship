...
- **Progress bar**: Always-visible horizontal bar tracks reading position
- **Distraction-free**: Minimal UI, stays out of the way while reading
...
**First-time toast**: "Press ? for keyboard shortcuts" (auto-dismisses after 5s)
