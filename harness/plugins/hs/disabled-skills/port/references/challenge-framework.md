...
Stress-test a porting decision before it becomes implementation work.
...
3. Existing overlap: already have part of this behavior?
4. Maintenance burden: who owns imported behavior post-port?
5. Dependency chain: what new deps/services/ops costs does this introduce?
