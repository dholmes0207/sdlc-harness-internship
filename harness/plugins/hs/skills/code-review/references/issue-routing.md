...
Within each review round, every confirmed finding is classified by category before acting. The classifier (`harness/scripts/review_issue_router.py`) returns one of two routes:
