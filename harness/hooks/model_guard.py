#!/usr/bin/env python3
"""model_guard.py — PreToolUse(Agent|Task) gate: enforce the model-bound posture.
...
(default ON block). The ONLY switch is the registration toggle `model_guard.enabled`
