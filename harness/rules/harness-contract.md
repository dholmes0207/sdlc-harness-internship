...
`harness/standards/README.md`). On-demand: `harness/rules/{workflow-handoffs,verification-mechanism,tdd-discipline}.md` + the knob index `docs/harness/config-reference.md`; skills hs:plan/cook/test.
