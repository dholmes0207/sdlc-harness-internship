...
Data fetching via TanStack Query: Suspense boundaries, cache-first strategies, centralized API services.
...
**Why:** API routing handled via proxy config, no `/api/` prefix needed.
