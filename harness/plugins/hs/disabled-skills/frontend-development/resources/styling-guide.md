...
MUI v7 styling patterns: sx prop, inline styles, theme integration.
...
**Guideline**: Comfortable with ~80 lines inline; use judgment around 100.
...
**Why avoid**: Deprecated; poor v7 support
...
**Why avoid**: sx prop is more flexible, no extra components
