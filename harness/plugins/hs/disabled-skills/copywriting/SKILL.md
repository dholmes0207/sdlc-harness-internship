...
Load: `references/writing-styles.md` (30 styles)

**Extract styles from multi-format files:**
```bash
python "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/copywriting/scripts/extract-writing-styles.py --list        # List files
python "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/copywriting/scripts/extract-writing-styles.py --style <name> # Extract style
```
...
**IMPORTANT:** Invoke "/hs:project-organization" skill to organize outputs.