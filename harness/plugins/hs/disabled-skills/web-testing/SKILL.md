...
Web testing: unit, integration, E2E, load, security, visual regression, accessibility.
...
- Does not apply to non-web targets (native mobile, CLI-only, backend-with-no-HTTP-surface) — use a project-native approach instead.
