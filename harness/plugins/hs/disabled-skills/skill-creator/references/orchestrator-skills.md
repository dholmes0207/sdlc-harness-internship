...
Full contract: the Orchestrator skill contract section in `harness/rules/workflow-handoffs.md` — read before writing.
...
- Has a clear input contract and handoff output (brief, map, verified fix).
