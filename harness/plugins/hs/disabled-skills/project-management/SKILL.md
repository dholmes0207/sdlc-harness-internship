...
Track plans, sync tasks, generate progress reports via the `@project-manager` agent (`harness/plugins/hs/agents/project-manager.md`). Does not implement code; never merges plans without human confirmation.
