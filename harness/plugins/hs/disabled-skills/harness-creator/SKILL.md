...
**Boundaries with hs:skill-creator**: this skill does NOT create `SKILL.md`/`hs:*` invocable skills — that's `hs:skill-creator`'s job. Primitives here typically back other skills.
